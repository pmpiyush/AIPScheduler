                  ...
                  <div class="row">
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="text" name="regStudent" id="input-id" class="form-control" required placeholder="Enter student time">
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
                        <label class="form-control-label" for="input-room">Date <span class="text-danger">*</span></label>
                        <input type="date" name="regDate" id="input-room" class="form-control" required placeholder="Ex : C202">
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
                        <label class="form-control-label" for="input-time">Time <span class="text-danger">*</span></label>
                        <input type="time" name="regTime" id="input-time" class="form-control" required placeholder="Enter single digit no.">
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
